    ...
    <footer className="mx-auto">
        ...
        <div className="mb-16 grid grid-cols-2 gap-12 pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
          <div className="col-span-full lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              >
                <img src="img/insta-foot.svg" alt="" className="icon-effect" />
              </a>
              <a
                rel="noreferrer"
                ...
                className="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600"
              >
                <img src="img/twt.svg" alt="" className="icon-effect" />
              </a>
              <a
                rel="noreferrer"
                ...
                className="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600"
              >
                <img src="img/github-foot.svg" alt="" className="icon-effect" />
              </a>
              <a
                rel="noreferrer"
                ...
                className="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600"
              >
                <img src="img/cord-foot.svg" alt="" className="icon-effect" />
              </a>
            </div>
            {/* social - end */}
          </div>
      ...
      >
        <div className="py-3 text-center text-sm text-gray-400">
          © 2022 - TheAlphaOnes - All Power Conserved
        </div>
      </div>
    </footer>
  );
