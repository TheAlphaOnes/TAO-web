      ...
      <section className="bg-[#0a0e16]">
        <section className="text-white body-font">
          <motion.div
            ...
            className="container flex flex-wrap px-5 py-24 pb-0 mx-auto items-center"
          >
            <div className="md:w-2/3 md:pr-12 md:py-5 md:border-b-0 md:mb-0 pb-10">
              ...
              <p
                className="leading-relaxed font-quicksand"
                id="about-title-dic"
              >
        ...
        <motion.div
          ...
          className="py-6 con-di sm:py-8 lg:py-12"
        >
          <div className="flex justify-center ml-[5%] mx-auto max-w-screen-2xl px-4 md:px-8">
