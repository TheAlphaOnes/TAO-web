  ...
  return (
    <div className="md:py-1 py-1 px-2 flex flex-wrap  max-w-fit justify-start gap-[7px]  w-full ">
      {tags.map((tag) => (
        ...
        >
          <div className="bg-[#0a0e16] rounded-[100px] text-[9px] font-[500] px-3 md:px-4  h-[16px] md:h-[19px] flex items-center relative -translate-y-[0.25px] md:translate-y-0">
      ...
      <div>
        <div className="flex gap-[7px] w-fit font-[400] text-[10px] md:text-[12px] my-1  md:text-inherit">
