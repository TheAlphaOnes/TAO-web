        ...
        <section id="about">
          ...
          <section>
            <div id="intro-box-con" className="con-about">
              <div
                className="flex flex-col rounded-lg  p-4 pt-6 mybox mybox1"
                id="intro-box-1"
              >
                <div className="mb-12">
                  <h1 className="title-about-num">Welcome to TheAlphaOnes!</h1>
                  <p className="about-title-dit">
                    Hello! We are TheAlphaOnes, a dynamic group of students with
                    a passion for all things tech-related. From software
                    development to AI/ML, UI/UX design, and hardware tech, we're
                    constantly exploring the latest innovations and pushing the
                    boundaries of what's possible.
                  </p>
                </div>
              </div>
              <div
                className="flex flex-col rounded-lg  p-4 pt-6 mybox mybox2"
                id="intro-box-2"
              >
                <div className="mb-12">
              ...
              <div
                className="flex flex-col rounded-lg  p-4 pt-6 mybox mybox3"
                id="intro-box-3"
              >
                <div className="mb-12">
                  <h1 className="title-about-num">
                  ...
                  <p className="about-title-dit">
                    Our goal is to bring together <br /> like-minded individuals
                    worldwide, pooling our skills and resources to develop
                    impactful, innovative solutions. Harnessing technology's
                    transformative potential, Driven to make a lasting impact.
                    Join us on our journey to become leading tech giants..
                  </p>
                </div>
              </div>
            </div>
